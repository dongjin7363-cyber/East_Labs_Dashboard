...
export default function UsEtfScreeningPage() {
  const [isZoomOpen, setZoomOpen] = useState(false);
  const [imageBroken, setImageBroken] = useState(false);
  const today = todayKstYmd();
  const recentSnapshots = useMemo(
    () => [
      { id: "r1", date: today, title: "US ETF Screening Snapshot" },
      { id: "r2", date: "2026-03-04", title: "US ETF Screening Snapshot" },
      { id: "r3", date: "2026-03-03", title: "US ETF Screening Snapshot" },
    ],
    [today],
  );
    ...
    <>
          ...
          <div className="market-etf-image-wrap">
            {imageBroken ? (
              ...
              <img
                ...
                alt="US Market ETF Screening sample"
      ...
      >
        <div className="market-zoom-image-wrap">
          <img
            src={SAMPLE_IMAGE_SRC}
            alt="US Market ETF Screening enlarged"
